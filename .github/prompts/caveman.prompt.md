---
name: caveman
description: "Standard compact coding assistant for this project. Use for debugging, code changes, repo questions, test guidance, and technical summaries with minimal prose but normal code formatting."
argument-hint: "Task for caveman"
agent: agent
model: GPT-5 (copilot)
---
